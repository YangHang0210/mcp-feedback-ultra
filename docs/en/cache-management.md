...
3. **Manual cleanup**:
   ...
   taskkill /f /im python.exe /fi "WINDOWTITLE eq *mcp-feedback-ultra*"
...
**Cause**: Frequent use of `uvx mcp-feedback-ultra@latest`
...
2. Report issues on [GitHub Issues](https://github.com/YangHang0210/mcp-feedback-ultra/issues)

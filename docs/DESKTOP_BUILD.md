...
```
src/mcp_feedback_ultra/
├── desktop_release/                                   # 發佈用二進制文件
│   ├── __init__.py
│   ├── mcp-feedback-ultra-desktop.exe              # Windows
│   ├── mcp-feedback-ultra-desktop-macos-intel     # macOS Intel
│   ├── mcp-feedback-ultra-desktop-macos-arm64     # macOS Apple Silicon
│   └── mcp-feedback-ultra-desktop-linux           # Linux
├── desktop_app/                                       # 發佈用 Python 模組
│   ├── __init__.py
│   └── desktop_app.py
└── ...

src-tauri/python/mcp_feedback_ultra_desktop/        # 開發環境模組
├── __init__.py
├── desktop_app.py
└── ...
```
...
- **Windows**: `mcp-feedback-ultra-desktop.exe`
- **macOS Intel**: `mcp-feedback-ultra-desktop-macos-intel`
- **macOS Apple Silicon**: `mcp-feedback-ultra-desktop-macos-arm64`
- **Linux**: `mcp-feedback-ultra-desktop-linux`
...
- 二進制檔案: `mcp-feedback-ultra-desktop.exe`

### Linux/macOS
- 二進制檔案: `mcp-feedback-ultra-desktop`
- 自動設置執行權限

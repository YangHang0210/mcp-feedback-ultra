...
### 🔄 Workflow
1. **AI Call** → `mcp-feedback-ultra` tool
...
follow mcp-feedback-ultra instructions
```
...
```bash
# Version check
uvx mcp-feedback-ultra@latest version       # Check version

# Interface testing
uvx mcp-feedback-ultra@latest test --web    # Test Web UI (auto continuous running)
uvx mcp-feedback-ultra@latest test --desktop # Test desktop application (v2.5.0 new feature)

# Debug mode
MCP_DEBUG=true uvx mcp-feedback-ultra@latest test

# Specify language for testing
MCP_LANGUAGE=en uvx mcp-feedback-ultra@latest test --web    # Force English interface
MCP_LANGUAGE=zh-TW uvx mcp-feedback-ultra@latest test --web  # Force Traditional Chinese
MCP_LANGUAGE=zh-CN uvx mcp-feedback-ultra@latest test --web  # Force Simplified Chinese
```
...
uv run python -m mcp_feedback_ultra test              # Standard functional testing
uvx --no-cache --with-editable . mcp-feedback-ultra test --web   # Web UI testing (continuous running)
uvx --no-cache --with-editable . mcp-feedback-ultra test --desktop # Desktop application testing
...
A: v2.4.0 completely removed PyQt6 GUI dependencies. To use legacy GUI, specify v2.3.0 or earlier: `uvx mcp-feedback-ultra@2.3.0`
...
A: Fixed in v2.0.3. Update to latest version: `uvx mcp-feedback-ultra@latest`
...
[![Star History Chart](https://api.star-history.com/svg?repos=Minidoracat/mcp-feedback-ultra&type=Date)](https://star-history.com/#Minidoracat/mcp-feedback-ultra&Date)

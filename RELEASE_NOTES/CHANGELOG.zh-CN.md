...
本文件记录了 **MCP Feedback Ultra** 的所有版本更新内容。
...
- **测试桌面模式**: `uvx mcp-feedback-ultra@latest test --desktop`
...
**完整项目信息：** [GitHub - mcp-feedback-ultra](https://github.com/YangHang0210/mcp-feedback-ultra)
